            ...
            ciphers = ciphers.filter((c) => {
                ...
                if (options.organizationid != null) {
                    ...
                    const organizationId =
                        options.organizationid === "null" ? null : options.organizationid;
                ...
                if (options.collectionid != null) {
                    ...
                    const collectionId =
                        options.collectionid === "null" ? null : options.collectionid;
                    if (
                        collectionId == null &&
                        (c.collectionIds == null || c.collectionIds.length === 0)
                    ) {
                        return true;
                    }
                    if (
